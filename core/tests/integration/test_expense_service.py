...
def test_remove_expense_reduces_total():
    ...
    """
    service = create_service()
    service.create_expense("Libro", 10, "Tienda", date.today())
    service.create_expense("Revista", 5, "Tienda", date.today())
...
def test_total_amount_after_removal():
    ...
    """
    service = create_service()
    service.create_expense("Cursos", 30, "Tienda", date.today())
    service.create_expense("Internet", 25, "Tienda", date.today())
